...
public class IhcService {
    ...
    //OpenAPIServiceServiceStub stub;

    //private OpenAPIService serviceService;

    public IhcService() {
        logger.info("Starting IhcService");
    }
    ...
    private OpenAPIService initializeClient() {
        try {
            ...
            //stub = new OpenAPIServiceServiceStub("http://192.168.0.55/ws/OpenAPIService");
